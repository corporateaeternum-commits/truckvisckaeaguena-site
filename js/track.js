...
var campaignID = "6a309778b1da9f1cc50bb207";
...
var initialSrc = "https://lp.voltaendrick.online/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("lp.voltaendrick.online/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://lp.voltaendrick.online/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://lp.voltaendrick.online/view?clickid=" + rtkClickID)
        xhrTrack.send();
